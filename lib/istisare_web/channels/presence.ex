defmodule IstisareWeb.Presence do
  @moduledoc """
  ...
  Presences can be tracked in your channel after joining:
      ...
      defmodule Istisare.MyChannel do
        use IstisareWeb, :channel
        alias Istisare.Presence
  ...
  """
  use Phoenix.Presence, otp_app: :istisare,
                        pubsub_server: Istisare.PubSub
end
